...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                               ...
                               mysqli_select_db($con, 'projet') ;
                                    $req = " select * from usertable order by name desc " ;
  ...
  <?php
                                        ...
                                        <?php
                                        $r="select name from usertable order by name desc" ; 
                                        $rs = mysqli_query($con,$r) ; 
                                        while($donnee = mysqli_fetch_assoc($rs))
                                        {
                                            $lg="<option value=".$donnee['name'].">".$donnee['name']."</option>" ; 
                                            echo $lg ; 
                                        }
